...
//    public Configuration jackson(Configuration configuration) throws IOException {
...
//        Configuration confJackson = objectMapper.readValue(new File("src/res.json"), Configuration.class);
//        configuration = confJackson;
